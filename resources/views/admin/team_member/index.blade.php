        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title"> Main Team Members </h3>
                                            ...
                                            @isset($members)
                                                @foreach($members as $member)
                                                    <tr>
                                                        <td>{{$member -> id}}</td>
                                                        <td>
                                                            <img style="width: 150px; height: 100px;" src="{{ url('front/photos/member/'.$member->photo)}}" class="w-16 h-16 rounded"></td>
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                 aria-label="Basic example">
                                                                <a href="{{route('admin.team_member.show',$member ->id)}}"
                                                                   class="btn btn-outline-amber btn-min-width box-shadow-3 mr-1 mb-1">show</a>
                                                                <a href="{{route('admin.team_member.edit',$member ->id)}}"
                                                                   class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">edit</a>
                                                                <a href="{{route('admin.team_member.delete',$member->id)}}"
