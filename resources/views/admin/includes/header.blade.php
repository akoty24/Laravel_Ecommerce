...
{{--            <li class="dropdown dropdown-notification nav-item">
                    ...
                    <li class="dropdown dropdown-user nav-item">
                     ...
                     <span class="user-name text-bold-700"> {{Auth::user()->name}} <i class="fa fa-angle-down" aria-hidden="true"></i></span>
                            <span class="avatar avatar-online">
                                <img  style="height: 35px;" src="{{url('front/photos/user/'.Auth::user()->photo)}}" alt="avatar"></span>
                        </a>
                        ...
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="{{route('profile')}}"><i
                            ...
                            <a class="dropdown-item" href="{{route('logout')}}"><i class="ft-power"></i> Logout
                                 </a>
                        </div>
                    </li>
                        @endif
