                    ...
                    <div class="card-body" style="margin: 30px">
                        <div class="row gutters">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <h3 class="mb-2 text-primary">Update Personal Details</h3>
                            </div>
                            @if ($errors->any())
                            ...
                            <form  method="POST" action="{{route('update.profile',$user->id)}}"   enctype="multipart/form-data">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label for="photo">Photo {{$user->photo}}</label>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input  type="text" name="lname" class="form-control" id="fullName" value="{{$user->lname}}">
                                    </div>
                                </div>
{{--                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">--}}
{{--                                    <div class="form-group">--}}
...
{{--                                </div>--}}
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input  type="number" name="pincode" class="form-control" id="zIp" value="{{$user->pincode}}">
                                    </div>
                                </div>
                                @endif
